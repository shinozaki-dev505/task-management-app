...
* **1.HOME（新規登録画面）**: `index.php`
  タスクを素早く入力・登録する入口です。
  <img width="725" height="639" alt="image" src="https://github.com/user-attachments/assets/40b620f4-96b2-41e5-b495-fedec1caafae" />
>>>>>>> 8a028b636c6ec8924fcbda38fc4d68a5b1c48a28
